...
const LoginPage = ({ darkMode }) => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post('https://saran-frontend.onrender.com/api/login', {
        email,
        password
      });
      ...
      const userBidsResponse = await axios.get(`https://saran-frontend.onrender.com/api/getUserBids/${email}`);
...
const handleForgotPassword = async () => {
  try {
    const response = await axios.post('https://saran-frontend.onrender.com/api/forgotPassword', { email });
