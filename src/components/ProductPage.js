...
const fetchWinningUser = async (productId) => {
  try {
    const winningUserResponse = await axios.get(`https://saran-frontend.onrender.com/api/getWinningBid/${productId}`);
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const response = await axios.get('https://saran-frontend.onrender.com/api/getBids');
        ...
        const winningUserPromises = response.data.bids.map(async (product) => {
          const winningUserResponse = await axios.get(`https://saran-frontend.onrender.com/api/getWinningBid/${product._id}`);
  ...
  fetchProducts();
    ...
    const fetchUserBids = async () => {
      ...
      if (userId){
        ...
        const userBidsResponse = await axios.get(`https://saran-frontend.onrender.com/api/getUserBids/${userId}`);
  ...
  const placeBid = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://saran-frontend.onrender.com/api/placeBid', {
      ...
      const updatedUserBidsResponse = await axios.get(`https://saran-frontend.onrender.com/api/getUserBids/${userId}`);
      setUserBids(updatedUserBidsResponse.data.userBids);

      // Update the bid for the product
      const updatedProductResponse = await axios.get(`https://saran-frontend.onrender.com/api/getBids/${selectedProduct.productId}`);
  ...
  const handleConfirmModifyBid = async (productId, newBid) => {
    try {
      const res = await axios.put(`https://saran-frontend.onrender.com/api/modifyBid/${productId}`, {
        newBid,
      });
