...
const SignupPage = ({ darkMode }) => {
  ...
  const handleSignup = async (e) => {
    ...
    console.log(obj);
    const url = "https://saran-frontend.onrender.com/api/signup";
  ...
  const sendWelcomeEmail = async (userEmail) => {
    const welcomeEmailUrl = "https://saran-frontend.onrender.com/api/sendWelcomeEmail"; // Create this endpoint on your server
